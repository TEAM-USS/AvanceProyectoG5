<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="RegistrarAlumno.aspx.cs" Inherits="CapaPresentacion.RegistrarAlumno" ClientIDMode="Static" %>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive">
                        <table id="tbl_alumnos" class="table table-bordered table-hover text-center">
                            <thead>
                                <tr>
                                    <th>Acciones</th>
                                    <th>Código</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Actualizar registro de alumno</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <asp:TextBox ID="txtModalCodigo" runat="server" Text="" CssClass="form-control" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <asp:TextBox ID="txtModalEdad" runat="server" Text="" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label>DIRECCIÓN</label>
                    </div>
